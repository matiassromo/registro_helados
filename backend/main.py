...
class SistemaVentas:
    def __init__(self):
        self.helados = {
            ...
            "3 Sabores Hielo": Helado("3 Sabores Hielo"),
            "Come y Bebe": Helado("Come y Bebe"),
            "Guanabana": Helado("Guanabana"),
            "Guanabana Mora": Helado("Guanabana Mora"),
            "Maracumango": Helado("Maracumango"),
            "Tamarimango": Helado("Tamarimango"),
            "Chocolate Hielo": Helado("Chocolate Hielo"),
            "Chocolate Coco": Helado("Chocolate Coco"),
            "3 Sabores Surtido": Helado("3 Sabores Surtido"),
            "Galleta": Helado("Galleta"),
            "Chocovainilla": Helado("Chocovainilla"),
            "Coco Crema": Helado("Coco Crema"),
            "Maracuya": Helado("Maracuya"),
            ...
            "Chocolate Chocovainilla": Helado("Chocolate Chocovainilla"),
            "Mora Galleta": Helado("Mora Galleta"),
            "3 Sabores Crema": Helado("3 Sabores Crema"),
